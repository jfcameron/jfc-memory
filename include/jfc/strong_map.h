...
#ifndef JFC_MEMORY_STRONG_MAP_H
#define JFC_MEMORY_STRONG_MAP_H
...
namespace jfc
{
    ...
    public:
        ...
        ///\{
        strong_map &operator=(const strong_map &) = delete;
        strong_map &operator=(strong_map &&) = delete;
        ///\}
            
        // Constructors, destructors
        ///\{
        strong_map() = default;
        strong_map(const strong_map&) = delete;
        strong_map(strong_map&&) = default;
        ~strong_map() = default;
        ///\}
    };
}
